...
import com.crud.www.service.MemberService;
...
public class LoginSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		setAuthName(authentication.getName());
		setAuthUrl("/board/list");
		
		boolean isOk=msv.updateLastLogin(getAuthName());
		...
		if(!isOk || ses==null) {
			...
			//security 에서 로그인을 시도하면 시도한 로그인 기록 남게 됨
			//이전에 시도한 security의 인증 실패 기록 삭제 
