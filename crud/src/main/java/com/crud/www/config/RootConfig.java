...
@EnableScheduling
@Configuration
@MapperScan(basePackages= {"com.crud.www.repository"})
@ComponentScan(basePackages= {"com.crud.www.service","com.crud.www.exception"})
public class RootConfig {
	...
	public DataSource dataSource() {
		...
		hikariConfig.setJdbcUrl("jdbc:log4jdbc:mysql://localhost:3306/crud");
